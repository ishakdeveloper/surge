...
import (
	...
	"github.com/ishakdeveloper/surge/gateway/internal/infrastructure/events"
	gatewaygrpc "github.com/ishakdeveloper/surge/gateway/internal/infrastructure/grpc"
	gatewayhttp "github.com/ishakdeveloper/surge/gateway/internal/infrastructure/http"
	"github.com/ishakdeveloper/surge/gateway/internal/infrastructure/ws"
...
func buildVerifier(ctx context.Context) (authz.Verifier, error) {
	...
	users, err := authz.NewJWKS(ctx, jwksURL, issuer, audience)
	if err != nil {
		return nil, err
	}
