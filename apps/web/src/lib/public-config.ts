...
export interface PublicConfig {
  ...
  /**
   * Address search. Unset, it is the public Photon instance, which is fair-use
   * only and answers some clients with a 503; a deployment points this at its
   * own.
   */
  readonly PLACES_URL: string | undefined;
}
...
export const fromEnvironment = (
  ...
  PLACES_URL: set(env["PLACES_URL"]) ?? import.meta.env.VITE_PLACES_URL,
});
