...
/**
 * The live city under a map: the cars free to take a trip in view, and a flash
 * wherever one was just booked. Pass `cars` and `flashes` to `SurgeMap`, and
 * its `onView` this `onView` — the map moving is what tells the gateway which
 * part of the city to send.
 */
