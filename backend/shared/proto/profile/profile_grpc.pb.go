...
const (
	ProfileService_GetMyProfile_FullMethodName    = "/surge.profile.v1.ProfileService/GetMyProfile"
	ProfileService_UpdateMyProfile_FullMethodName = "/surge.profile.v1.ProfileService/UpdateMyProfile"
	ProfileService_UploadAvatar_FullMethodName    = "/surge.profile.v1.ProfileService/UploadAvatar"
	ProfileService_RemoveAvatar_FullMethodName    = "/surge.profile.v1.ProfileService/RemoveAvatar"
	ProfileService_GetProfile_FullMethodName      = "/surge.profile.v1.ProfileService/GetProfile"
)
...
//
// ProfileService is who someone is to the people they ride with: a first name
// and a photo. The rider looks for the driver's face at the kerb; the driver
// looks for the rider's.
//
// A photo is sent here, not to the object store: the core service crops it to
// a square and re-encodes it, which drops whatever a phone wrote into it — the
// place it was taken included — before anything is stored. What comes back is
// a link signed for a couple of hours, the same link for everyone asking within
// the hour, so a browser caches it.
//
// Any signed-in caller may read anyone's profile by id: a user id only reaches
// someone through a trip or a conversation they share, and a first name and a
// photo are what that person sees anyway.
type ProfileServiceClient interface {
	...
	// UpdateMyProfile sets the caller's first name.
...
func (c *profileServiceClient) UpdateMyProfile(ctx context.Context, in *UpdateMyProfileRequest, opts ...grpc.CallOption) (*UpdateMyProfileResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *profileServiceClient) RemoveAvatar(ctx context.Context, in *RemoveAvatarRequest, opts ...grpc.CallOption) (*RemoveAvatarResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RemoveAvatarResponse)
	err := c.cc.Invoke(ctx, ProfileService_RemoveAvatar_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProfileServiceServer) UpdateMyProfile(context.Context, *UpdateMyProfileRequest) (*UpdateMyProfileResponse, error) {
...
func (UnimplementedProfileServiceServer) RemoveAvatar(context.Context, *RemoveAvatarRequest) (*RemoveAvatarResponse, error) {
...
func _ProfileService_RemoveAvatar_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RemoveAvatarRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProfileServiceServer).RemoveAvatar(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProfileService_RemoveAvatar_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfileServiceServer).RemoveAvatar(ctx, req.(*RemoveAvatarRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProfileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "surge.profile.v1.ProfileService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProfileService_RemoveAvatar_Handler,
		},
		{
